...
| Priority field (high / medium / low) on commitments | ✓ Built |
| Tags writable on PATCH + tag autocomplete endpoint | ✓ Built |
| Commitment tracker (dashboard) | ✓ Built |
| Commitment actions (confirm, reject, escalate, resolve, nudge) | ✓ Built |
